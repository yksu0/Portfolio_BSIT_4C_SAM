...
const projects = [
  {
    ...
    details:
      "Designed and implemented a fully customized GRUB bootloader theme with a graphical menu for selecting between multiple Linux distributions and Windows installations. Organized menu entries, automated OS detection scripts, and a clean terminal-style interface. The configuration supports chainloading for Windows and direct kernel booting for Linux distros.",
    features: [
      "Custom graphical GRUB theme",
      "Multi-OS chainloading support",
      "Automated OS detection via scripts",
      "Clean terminal-style boot menu",
    ],
    screenshots: [
      { label: "GRUB Menu", src: "/images/grub/grub.jpg" },
      { label: "Boot Menu Top", src: "/images/grub/grub top.jpg" },
      { label: "Boot Menu Bottom", src: "/images/grub/grub bottom.jpg" },
    ],
    tech: ["Bash", "Linux", "GRUB"],
    cover: "/images/grub/grub.jpg",
    accent: { border: "rgba(0,245,255,0.35)", glow: "rgba(0,245,255,0.18)", text: "#00f5ff", bg: "rgba(0,245,255,0.1)" },
  },
  {
    title: "Custom Audio Configuration for Linux",
    description:
      "A custom audio settings system for Linux using JSON, BAT, and SH scripts to manage and switch audio profiles.",
    details:
      "Built a custom audio configuration system for Linux that allows quick switching between audio profiles and settings using lightweight scripts. The setup uses JSON files for storing profile configurations, shell scripts for applying settings on Linux, and BAT scripts for cross-platform compatibility. Features include per-application volume control, output device switching, and automated profile loading on system startup.",
    features: [
      "JSON-based audio profile storage",
      "Shell scripts for applying Linux audio settings",
      "BAT scripts for cross-platform support",
      "Per-application volume control",
      "Automated profile loading on startup",
    ],
    screenshots: [
      { label: "Audio Configuration", src: "/images/audio/651031086_2604048280033073_8220901471675112734_n.jpg" },
      { label: "Settings Interface", src: "/images/audio/651195904_955324867674218_4440261433178896377_n.jpg" },
    ],
    tech: ["JSON", "Bash", "BAT", "Linux"],
    cover: "/images/audio/651031086_2604048280033073_8220901471675112734_n.jpg",
